...
public class Parking {
	...
	public Parking isSolved() {
		/*
		 * Si le Parking est deja resolu, retourne le dernier Parking sous forme d'une feuille de l'arbre des deplacements.
	...
	public String isImpossible() {
		/*
		 * Si le Parking n'a pas de solution de par la situation du Goal Car, retourne la raison
	...
	public ArrayList<Parking> getNextParkings() {
		 ...
		 * pouvant etre obtenus en deplacant une seule voiture d'une seule position.
	...
	private Parking goalCarToExit() {
		/*
		 * Prend pour acquis que le Goal Car est libre et genère la suite de la branche partant du parking
		...
		//Tant que Goal Car n'est pas devant sortie
			...
			newCarPositions[0] += maxGoalPosition; //Voiture Goal se deplace d'une position
	...
	public boolean equals(Object o) {
		/*
		 * Redefinit la methode d'égalite pour permettre le hashing de l'objet Parking.
